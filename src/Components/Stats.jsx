...
const Stats = () => {
  ...
  return (
    <div className="min-h-[50vh] w-full">
      <p
        ref={paraRef}
        className="block font-[Light] text-[#767675] w-full text-[18.5px] leading-5"
      >
      ...
      <div className="w-full mt-10 flex gap-5 flex-wrap overflow-hidden bg-green-400
      ">
        <div className="h-[30vh] w-[30%] bg-red-500">
